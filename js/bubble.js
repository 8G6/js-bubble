...
class Bubble{
    ...
    animate = () =>{
        ...
        for(i=0;i<this.bubble_count;i++){
            ...
            $(`#bubble-${i}`).style.boxShadow = `inset ${this.sizes[i]*this.y[i]/this.max_x}px ${this.x[i]/this.max_x}px ${this.x[i]/this.max_y}px ${this.y[i]/this.max_x}px white`
            console.log(`inset ${this.y[i]/this.max_x}px ${this.sizes[i]*this.x[i]/this.max_x}px ${this.x[i]/this.max_y}px ${this.y[i]/this.max_x}px white`)
        }
